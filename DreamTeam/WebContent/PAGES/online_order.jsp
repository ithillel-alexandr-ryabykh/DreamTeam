      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav nav-pills navbar-left">
            ...
            <li class="active"><a href="online_order.html"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Online Order</a>
            </li>
        ...
        <div class="col-sm-offset-1 col-sm-5 col-md-offset-2 col-md-4">
          <div class="thumbnail">
            ...
            <div class="caption text-center">
              <h3>Online Order</h3>
              <h4>(5% discount*)</h4>
              <p>Preview our <a href="menu.html">Menu</a></p>
