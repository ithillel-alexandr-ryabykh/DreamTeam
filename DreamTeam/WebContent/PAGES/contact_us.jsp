      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav nav-pills navbar-left">
            ...
            <li class="active"><a href="contact_us.html"><span class="glyphicon glyphicon-phone-alt" aria-hidden="true"></span> Contact Us</a>
            </li>
          </ul>
        </div>       
      </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <a href="contact_us.html" class="btn btn-default" role="button">Close</a>
                  </div>
                </div>
              </div>
            </div>
